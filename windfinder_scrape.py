...
for num in range(len(url_spots_list)):
    ...
    exec_end = time.time()
    total_exec += (exec_end-exec_start)
    web_start = time.time()
    ...
    save_end = time.time()
    total_save += (save_end-save_start)
...
print("total web: " + str(total_web))
print("total exec: " + str(total_exec))
print("total save: " + str(total_save))
